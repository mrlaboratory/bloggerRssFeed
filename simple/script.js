var homepage        = "https://www.mrlaboratory.info",
    ...
    showcomment     = false, // Show comment number corrected to false if not displayed
    showsnippet     = false, // Show summary corrected to false if not displayed
    showinfo        = false, // Displays the read more button and the share button corrects to false if not displayed
    showreadmore    = false, // Show the read more button corrected to false if not displayed
    showshare       = false, // Show the share button edited to false if not shown
